...
values."
  ...
  (setq-default
   ...
   ;; `spacemacs-buffer-startup-lists-l ngth' takes effect.
   dotspacemacs-startup-lists '((recents . 5)
                                (projects . 7))
   ;; True if the home buffer should respond to resize events.
   dotspacemacs-startup-buffer-responsive t
   ;; Default major mode of the scratrh buffer (default `text-mode')
...
you should place your code here."
  ...
  (setq-default
   ...
   c-basic-offset 4
   tab-width 4)
  (setq org-latex-inputenc-alist '(("english,russian" "babel" t)))
